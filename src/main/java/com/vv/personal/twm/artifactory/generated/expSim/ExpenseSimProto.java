  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      public Builder mergeFrom(com.vv.personal.twm.artifactory.generated.expSim.ExpenseSimProto.Transaction other) {
        ...
        if (java.lang.Double.doubleToRawLongBits(other.getAmt()) != 0) {
          setAmt(other.getAmt());
        }
...
com.vv.personal.twm.artifactory.generated.expSim.ExpenseSimProto.Bank defaultValue) {
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(com.vv.personal.twm.artifactory.generated.expSim.ExpenseSimProto.Statement result) {
        ...
        if (((from_bitField0_ & 0x00000002) != 0)) {
          result.bankMap_ = internalGetBankMap().build(BankMapDefaultEntryHolder.defaultEntry);
        }
        if (((from_bitField0_ & 0x00000004) != 0)) {
          result.note_ = note_;
        }
      ...
      public int getBankMapCount() {
        return internalGetBankMap().ensureBuilderMap().size();
      }
      /**
       * <code>map&lt;string, .Bank&gt; bankMap = 2;</code>
       */
...
com.vv.personal.twm.artifactory.generated.expSim.ExpenseSimProto.Bank defaultValue) {
      ...
      public com.vv.personal.twm.artifactory.generated.expSim.ExpenseSimProto.Bank.Builder putBankMapBuilderIfAbsent(
        ...
        if (entry instanceof com.vv.personal.twm.artifactory.generated.expSim.ExpenseSimProto.Bank) {
          entry = ((com.vv.personal.twm.artifactory.generated.expSim.ExpenseSimProto.Bank) entry).toBuilder();
          builderMap.put(key, entry);
        }
